...
class MagnumConan(ConanFile):
    ...
    topics = ("conan", "corrade", "graphics",
              "rendering", "3d", "2d", "opengl")
    ...
    def requirements(self):
        self.requires("corrade/2020.06@werto87/stable")
        # use sdl2 and gl from emscripten if we build for emscripten
        if self.options.with_sdl2application and not self.settings.os == "Emscripten":
    ...
    def source(self):
        ...
        git.clone("https://github.com/mosra/magnum.git", "master")
    ...
    def _configure_cmake(self):
        ...
        if self.settings.os == "Emscripten":
            ...
            cmake.definitions["CMAKE_PREFIX_PATH"] = self.deps_cpp_info["corrade"].rootpath
            cmake.definitions["CMAKE_FIND_ROOT_PATH"] = self.deps_cpp_info["corrade"].rootpath
            cmake.definitions["WITH_EMSCRIPTENAPPLICATION"] = True
            cmake.definitions["WITH_AUDIO"] = True
            cmake.definitions["WITH_SDL2APPLICATION"] = True
            cmake.definitions["WITH_WINDOWLESSEGLAPPLICATION"] = True
            cmake.definitions["WITH_ANYAUDIOIMPORTER"] = True
            cmake.definitions["WITH_ANYIMAGECONVERTER"] = True
            cmake.definitions["WITH_ANYIMAGEIMPORTER"] = True
            cmake.definitions["WITH_ANYSCENECONVERTER"] = True
            cmake.definitions["WITH_ANYSCENEIMPORTER"] = True
            cmake.definitions["WITH_ANYSHADERCONVERTER"] = True
            cmake.definitions["WITH_MAGNUMFONT"] = True
            cmake.definitions["WITH_OBJIMPORTER"] = True
            cmake.definitions["WITH_TGAIMAGECONVERTER"] = True
            cmake.definitions["WITH_TGAIMPORTER"] = True
            cmake.definitions["WITH_WAVAUDIOIMPORTER"] = True
            cmake.definitions["WITH_GL_INFO"] = True
            cmake.definitions["WITH_AL_INFO"] = True
    ...
    def package_info(self):
        ...
        self.cpp_info.libs = sort_libs(
            correct_order=allLibs, libs=builtLibs, lib_suffix=suffix, reverse_result=True)
